   ...
   <div className="justify-center items-start gap-[87px] inline-flex">
      <div className="flex-col justify-start items-start gap-4 inline-flex">
         ...
         <div className="w-[217px] pl-4 py-3 rounded border border-neutral-50 justify-start items-center gap-8 inline-flex">
            ...
            <div className="w-6 h-6 px-0.5 py-[3px] justify-center items-center flex"></div>
         </div>
      </div>
      <div className="flex-col justify-start items-start gap-6 inline-flex">
         <div className="text-neutral-50 text-xl font-medium font-['Poppins'] leading-7">Support</div>
         <div className="flex-col justify-start items-start gap-4 flex">
            <div className="w-[175px] text-neutral-50 text-base font-normal font-['Poppins'] leading-normal">tunisia , sousse </div>
            <div className="text-neutral-50 text-base font-normal font-['Poppins'] leading-normal">slimvuns@gmail.com</div>
            <div className="text-neutral-50 text-base font-normal font-['Poppins'] leading-normal">+216 28-832-054</div>
         </div>
      </div>
      <div className="flex-col justify-start items-start gap-6 inline-flex">
         ...
         <div className="flex-col justify-start items-start gap-6 flex">
            ...
            <div className="flex-col justify-start items-start gap-2 flex">
               ...
               <div className="justify-start items-center gap-2 inline-flex">
                  {/* <div className="w-20 h-20 p-0.5 bg-black justify-center items-center flex"><img className="w-[76px] h-[76px] border-2 border-white" src="https://via.placeholder.com/76x76"></div> */}
                  <div className="flex-col justify-start items-start gap-1 inline-flex">
                     {/* <div className="w-[110px] h-10 relative bg-black"><img className="w-[104px] h-[30px] left-[3px] top-[5px] absolute rounded border border-neutral-50" src="https://via.placeholder.com/104x30"></div> */}
                     {/* <div className="w-[110px] h-10 p-[3px] bg-black justify-center items-center inline-flex"><img className="w-[104px] h-[34px] rounded border border-white" src="https://via.placeholder.com/104x34"></div> */}
                  </div>
               </div>
            </div>
         </div>
         <div className="justify-start items-start gap-6 inline-flex">
            <div className="w-6 h-6 pl-[7px] pr-[6.50px] py-[3px] justify-center items-center flex"></div>
            ...
            <div className="w-6 h-6 pl-[3px] pr-[3.50px] pt-[3px] pb-[3.50px] justify-center items-center flex"></div>
         </div>
      </div>
   </div>
   <div className="opacity-40 flex-col justify-start items-center gap-4 inline-flex">
      ...
      <div className="opacity-60 justify-start items-center gap-3 inline-flex">
         <div className="justify-start items-center gap-1.5 flex">
            ...
            <div className="text-white text-base font-normal font-['Poppins'] leading-normal">Copyright aymen { new Date().getFullYear()}. All right reserved</div>
         </div>
      </div>
   </div>
</div>
